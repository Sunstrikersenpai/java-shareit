...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> create(Long userId, BookingShortDto bookingDto) {
    ...
    public ResponseEntity<Object> findAllBookingsByUserId(Long userId, BookingState state) {
